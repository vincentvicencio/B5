...
<div id="respondents" class="py-6 sm:py-12">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Table -->
        <div class="py-4">
            <div class="table-container bg-white rounded-3 shadow-sm border p-4">
                <table class="table table-hover align-middle mb-0" id="respondents-table">
                    <thead class="table-header">
                        <tr class="text-uppercase text-secondary" id="respondents-table-header">
                            ...
                            {{-- Dynamic Trait Headers injected by JS --}}
                    ...
                    <tbody id="respondents-table-body">
                        <tr>
                            <td colspan="10" class="text-center py-4 text-muted">Loading respondents data...</td>
                        </tr>
                    </tbody>
                </table>

                <!-- Footer / Pagination -->
                <div id="table-footer" class="d-flex justify-content-between align-items-center pt-3 flex-wrap gap-2">
                    <span id="record-info" class="text-muted small"></span>
                    <nav aria-label="Table Pagination" id="pagination-controls"></nav>
                </div>
            </div>
        </div>
