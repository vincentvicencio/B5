...
<div id="manage-create" class="container-fluid px-4">
    ...
    <div class="trait-card mb-4">
        <div class="p-4">
            ...
            <form id="traitForm">
                @csrf
                <div class="mb-3">
                    <label for="traitTitle" class="form-label fw-semibold">Trait Title <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="traitTitle" name="traitTitle" placeholder="Enter your section title" required>
                </div>
                <div class="mb-3">
                    <label for="traitDescription" class="form-label fw-semibold">Description <span class="text-danger">*</span></label>
                    <textarea class="form-control" id="traitDescription" name="traitDescription" rows="3" placeholder="Describe what this section measures..." required></textarea>
                </div>
                <div class="mb-0">
                    <label for="traitColor" class="form-label fw-semibold d-block">Display Color (Hex Code)</label>
                    <input type="color" class="form-control form-control-color w-100" id="traitColor" name="traitColor" value="#172c43" title="Choose your color" required>
                </div>
        ...
        <div class="p-4">
            ...
            <div class="mb-4">
                ...
                <div class="d-flex gap-2">
                    <input type="text" class="form-control" id="newSubTraitInput" placeholder="Enter your sub-trait name" onkeypress="handleSubTraitInput(event)">
                    <button type="button" class="btn btn-add-subtrait px-4 text-nowrap" id="addSubTraitBtn" onclick="addSubTraitFromInput()">
            ...
            <div class="question-form-area mt-4">
                <div class="mb-3">
                    <label for="questionSubTraitSelect" class="form-label fw-semibold">Select sub-trait for question</label>
                ...
                <div class="mb-3">
                    ...
                    <small class="text-muted d-block mt-2">Respondents will answer based on the provided rating scale, where 1 represents Strongly Disagree, 2 is Disagree, 3 is Neutral, 4 is Agree, and 5 is Strongly Agree.</small>
                </div>

                <button type="button" class="btn btn-add-question w-100 py-3" id="addQuestionToListBtn" onclick="addQuestionToList()">
    ...
    <div class="d-flex justify-content-end gap-3 pb-5">
        <button type="button" class="btn btn-cancel px-5 py-2" onclick="window.location.href='{{ route('manage.index') }}'">Cancel</button>
    ...
    <div class="modal-dialog modal-dialog-start modal-lg">
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-header border-0 pb-0">
                <h5 class="modal-title fw-bold text-header-color" id="editQuestionModalLabel">
                    <p class="text-white"> Edit Question </p>
                </h5>
            ...
            <div class="modal-body pt-2">
                ...
                <div class="mb-3">
                    <label for="editQuestionSubTraitSelect" class="form-label fw-semibold">Sub-trait/Subsection</label>
            ...
            <div class="modal-footer border-0 pt-2">
                <button type="button" class="btn btn-outline-secondary btn-md p-2 m-2" data-bs-dismiss="modal">Cancel</button>
                {{-- CRITICAL ID: The JS event listener for confirmEditQuestion() is attached to this button --}}
                <button 
                    type="button" 
                    class="btn btn-primary btn-save" 
                    id="confirmEditQuestionBtn"
                    {{-- NOTE: The onclick is handled by a listener in initManageLogic() --}}
                >
...
<div id="saveConfirmationModal" class="modal fade" tabindex="-1" aria-labelledby="saveConfirmationModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-start-centered modal-md">
        <div class="modal-content border-0 shadow">
            
            <div class="modal-header border-0 pb-0">
                <h5 class="modal-title fw-bold text-header-color" id="saveConfirmationModalLabel">
                    <p class="text-white">Confirm Save </p>
                </h5>
                <button type="button" class="btn-close btn-close-white mb-2" data-bs-dismiss="modal" aria-label="Close"></button> 
            </div>
            ...
            <div class="modal-body pt-2">
                <p class="text-dark mb-2">
                    You are about to save the new Trait: <strong id="saveTraitNamePlaceholder" class="text-dark"></strong>. 
                </p>
            ...
            <div class="modal-footer border-0 pt-2">
                ...
                <button type="button" class="btn btn-primary px-4 btn-save" onclick="confirmSave()"> {{-- Added btn-save --}}
                    <i class="bi bi-check-lg me-1"></i> Yes, Save Trait
                </button>
            </div>
...
<div id="editSubTraitModal" class="modal fade" tabindex="-1" aria-labelledby="editSubTraitModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-start modal-md">
        <div class="modal-content border-0 shadow">
            
            <div class="modal-header border-0 pb-0">
                <h5 class="modal-title fw-bold text-header-color" id="editSubTraitModalLabel">
                    <p class="text-white"> Edit Subsection Name </p>
                </h5>
                <button type="button" class="btn-close btn-close-white mb-2" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <div class="modal-footer border-0 pt-2">
                <button type="button" class="btn btn-outline-secondary btn-md p-2 m-2" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-primary btn-sm btn-save" id="confirmEditSubTraitBtn"> {{-- Added btn-save --}}
                    <i class="bi bi-check-lg me-1 btn-sm"></i> Save Changes
                </button>
            </div>
